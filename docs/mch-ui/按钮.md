...
<template>
  <div class="btns">
    <mc-btn class="btn-mg" :type="'primary'" :size="'giant'">巨大(giant)</mc-btn>
    <mc-btn class="btn-mg" :type="'primary'" :size="'jumbo'">特大(jumbo)</mc-btn>
    <mc-btn class="btn-mg" :type="'primary'" :size="'large'">大(large)</mc-btn>
    <mc-btn class="btn-mg" :type="'primary'" :size="'normal'">正常(normal)</mc-btn>
...
<template>
  <div class="btns">
    ...
    <mc-btn class="btn-mg" :type="'primary'" :sharpe="'rounded'">rounded</mc-btn>
...
<template>
  <div class="btns">
    <mc-btn class="btn-mg" :isdisabled="true" >disabled</mc-btn>
  </div>
</template>
```
...
<template>
  <div class="btns">
    ...
    <mc-btn class="btn-mg" :hover="'wobble-horizontal'"
    ...
    <mc-btn class="btn-mg" :hover="'box-shadow-outset'"
    ...
    <mc-btn class="btn-mg" :hover="'curl-bottom-right'"
